function createAccordeonList() {
    let e = Array.from(document.querySelectorAll(".cloud__list"));
    e.forEach((t) => {
        let r = t.querySelector("button"),
            a = t.querySelector(".cloud__list-content"),
            n = t.querySelector(".cloud__list-header"),
            l = a.scrollHeight;
        n.addEventListener("click", () => {
            e.forEach((e, t) => {
                let a = r.parentElement.parentElement.getAttribute("data-id");
                Number(a) !== Number(t) &&
                    ((e.querySelector(".cloud__list-content").style.maxHeight =
                        "0px"),
...
createAccordeonList();
const buscaInput = setInterval(() => {
        let e = document.querySelector("input[name='phone']");
        e || console.log("n\xe3o achou"),
            e &&
                (clearInterval(buscaInput),
                e.addEventListener("input", handlePhoneInput, !1));
    }, 300),
...
const buscaUrlPagina = setInterval(() => {
    let e = document.querySelector("input[name='url_pagina']");
    e && (clearInterval(buscaUrlPagina), (e.value = location.href));
}, 300);
...
$(document).ready(() => {
    ...
    setTimeout(function () {
            ...
            var A = function (a, d, b) {
                    ...
                    var c = {
                        ...
                        getMCharsBeforeCount: function (e, a) {
                            for (
                                var c = 0, b = 0, f = d.length;
                                b < f && b < e;
                                b++
                            )
                                h.translation[d.charAt(b)] ||
                                    ((e = a ? e + 1 : e), c++);
                            return c;
                        },
                        caretPos: function (e, a, b, g) {
                            return h.translation[
                                d.charAt(Math.min(e - 1, d.length - 1))
                            ]
                                ? Math.min(e + b - a - g, b)
                ...
                z = function () {
                    ...
                    "false" === a.attr("data-mask-maxlength") &&
                        (d.maxlength = !1);
                    a.attr("data-mask-clearifnotmatch") &&
                        (d.clearIfNotMatch = !0);
        ...
        $("#phone-9182a940-ca73-4ac7-95cf-347b57222953").mask(
            "+00 (00) 00000-0009"
        );

        $("#phone-9182a940-ca73-4ac7-95cf-347b57222953").blur(function (event) {
